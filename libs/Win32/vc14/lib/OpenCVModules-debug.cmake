...
set_target_properties(opencv_flann PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_flann320d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_core"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_flann320d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_flann )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_flann "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_flann320d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_flann320d.dll" )
...
set_target_properties(opencv_ml PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_ml320d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_core"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_ml320d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_ml )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ml "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_ml320d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_ml320d.dll" )
...
set_target_properties(opencv_photo PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_photo320d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_core;opencv_imgproc"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_photo320d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_photo )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_photo "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_photo320d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_photo320d.dll" )
...
set_target_properties(opencv_video PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_video320d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_core;opencv_imgproc"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_video320d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_video )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_video "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_video320d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_video320d.dll" )
...
set_target_properties(opencv_shape PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_shape320d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_core;opencv_imgproc;opencv_video"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_shape320d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_shape )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_shape "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_shape320d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_shape320d.dll" )
...
set_target_properties(opencv_objdetect PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_objdetect320d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_objdetect320d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_objdetect )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_objdetect "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_objdetect320d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_objdetect320d.dll" )
...
set_target_properties(opencv_superres PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_superres320d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_core;opencv_imgproc;opencv_video;opencv_imgcodecs;opencv_videoio"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_superres320d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_superres )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_superres "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_superres320d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_superres320d.dll" )
...
set_target_properties(opencv_features2d PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_features2d320d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_features2d320d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_features2d )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_features2d "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_features2d320d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_features2d320d.dll" )
...
set_target_properties(opencv_calib3d PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_calib3d320d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_calib3d320d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_calib3d )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_calib3d "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_calib3d320d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_calib3d320d.dll" )
...
set_target_properties(opencv_stitching PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_stitching320d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_stitching320d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_stitching )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_stitching "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_stitching320d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_stitching320d.dll" )
...
set_target_properties(opencv_videostab PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_videostab320d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_videostab320d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_videostab )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_videostab "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_videostab320d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_videostab320d.dll" )
